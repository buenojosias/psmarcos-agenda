...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/eventos/{event}/editar', App\Livewire\Events\Edit::class)->name('events.edit');
    Route::get('/eventos/{event}/auditoria', App\Livewire\Events\Audit::class)->name('events.audit');
